...
<style>@media screen and (max-width:600px){.shell{padding:12px!important}.card{border-radius:18px!important}.hero{padding:28px 22px!important}.content{padding:26px 22px!important}.title{font-size:27px!important}.detail{display:block!important;width:100%!important;padding:11px 24px!important}.legal-links{white-space:nowrap!important}.legal-link{display:inline-block!important;margin:0 6px!important;font-size:11px!important}.verse{padding:16px 22px!important}.verse-text{font-size:12px!important;line-height:1.65!important}}</style></head>
...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:28px"><tr><td class="legal-links" style="padding:18px 0;border-top:1px solid #e1eeeb;border-bottom:1px solid #e1eeeb;text-align:center"><p style="margin:0 0 10px;font-size:12px;font-weight:800;color:#64736f">Para más información, visita:</p><a class="legal-link" href="${escapeHtml(policiesUrl)}" style="display:inline-block;margin:0 10px;color:#0b6962;font-size:12px;font-weight:700;text-decoration:underline">Políticas de uso</a><span aria-hidden="true" style="color:#a0aaa7;font-size:12px">|</span><a class="legal-link" href="${escapeHtml(termsUrl)}" style="display:inline-block;margin:0 10px;color:#0b6962;font-size:12px;font-weight:700;text-decoration:underline">Términos y condiciones</a></td></tr></table>
</td></tr>
<tr><td class="verse" style="padding:18px 34px 20px;background:#fff;border-top:1px solid #edf2f0;text-align:center"><p class="verse-text" style="margin:0 auto;max-width:500px;font-size:12px;line-height:1.7;font-style:italic;font-weight:400;color:#7b8985">“Y el Dios de esperanza os llene de todo gozo y paz en el creer, para que abundéis en esperanza.”</p><p style="margin:6px 0 0;font-size:10px;line-height:1.4;font-weight:700;letter-spacing:1.6px;text-transform:uppercase;color:#a0aaa7">Romanos 15:13</p></td></tr>
