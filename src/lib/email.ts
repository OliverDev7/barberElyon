...
<style>@media screen and (max-width:600px){.shell{padding:12px!important}.card{border-radius:18px!important}.hero{padding:28px 22px!important}.content{padding:26px 22px!important}.title{font-size:28px!important}.detail{display:block!important;width:100%!important;padding:10px 0!important}.legal-link{display:block!important;margin:8px 0!important}}</style></head>
...
<tr><td class="hero" style="padding:34px;background:#042f2e;color:#fff"><div style="font-size:12px;letter-spacing:4px;font-weight:800;color:#bfe7df">ELYON BARBER ESTUDIO</div><h1 class="title" style="margin:18px 0 0;font-size:34px;line-height:1.15;font-weight:800">Tu reserva está confirmada</h1><p style="margin:12px 0 0;font-size:15px;line-height:1.7;color:#d9eeea">Tu próxima visita ya tiene su hora asegurada.</p></td></tr>
<tr><td class="content" style="padding:34px"><p style="margin:0;font-size:17px;line-height:1.65">Hola <strong>${escapeHtml(greeting)}</strong>,</p><p style="margin:8px 0 0;font-size:15px;line-height:1.7;color:#64736f">Gracias por reservar con ELYON BARBER. Aquí tienes todos los datos de tu cita.</p>
...
<tr><td style="padding:16px 20px;border-top:1px solid #d7e9e5"><span style="color:#64736f;font-size:13px;font-weight:700">Precio</span><div style="margin-top:4px;font-size:24px;font-weight:800;color:#042f2e">${formatPrice(data.price)}</div></td></tr></table>
...
<div style="margin-top:24px;text-align:center"><p style="margin:0;font-size:14px;line-height:1.7;color:#64736f">Te esperamos en ELYON BARBER.</p></div></td></tr>
<tr><td style="padding:20px 34px;background:#f7faf8;border-top:1px solid #e1eeeb;text-align:center"><div style="font-size:11px;letter-spacing:2px;font-weight:800;color:#042f2e">ELYON BARBER ESTUDIO</div><p style="margin:8px 0 0;font-size:11px;line-height:1.5;color:#7b8985">© ELYON BARBER ESTUDIO — TODOS LOS DERECHOS RESERVADOS</p><p style="margin:5px 0 0;font-size:11px;line-height:1.5;color:#7b8985">Este correo confirma los datos de tu reserva.</p></td></tr></table></td></tr></table></body></html>`;
}
