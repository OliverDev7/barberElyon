...
export function BrandMark({ dark = false }: { dark?: boolean }) {
  return <div className="flex items-center gap-3"><div className={`grid h-10 w-10 place-items-center rounded-full border ${dark ? "border-white/20 bg-white" : "border-teal-100 bg-teal-50"} text-[11px] font-black ${dark ? "text-teal-950" : "text-teal-950"}`}>EB</div><div><p className="text-sm font-black tracking-[0.18em] text-current">ELYON BARBER</p><p className="text-xs text-neutral-500"></p></div></div>;
}
